...
def extract_name_from_anneam(pdf_path: Path) -> str | None:
    """안내문 PDF에서 성명 추출"""
    try:
...
def extract_jumin6_from_jipgum(pdf_path: Path) -> str | None:
...
def find_folder_by_jumin6(jumin6: str) -> Path | None:
